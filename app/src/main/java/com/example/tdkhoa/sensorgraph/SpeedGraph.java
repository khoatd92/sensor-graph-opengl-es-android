...
public class SpeedGraph extends BaseGraph {
    ...
    public SpeedGraph(Context context, GraphInfo graphInfo) {
    ...
    @Override public void draw(ShaderProgram shaderProgram) {
        ...
        GLES20.glUniform4f(graphShaderProgram.getColorLocation(), 1.0f, 1.0f, 0.0f, 1.0f);
